...
{
    float can, can1, can10, can20, can50, can100, can5, cm50, cm25, cm5, cm10;
    can = can1 = can10 = can20 = can50 = can100 = can5 = cm50= cm25= cm5= cm10= 0.00f;
    ...
    Console.WriteLine($"Monedas de 0.01={can}");
}
